...
## Project Structure
    ...
    ├── testapiautoconnect_105354  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_105354`
...
2. Clone this repo and `cd testapiautoconnect_105354`
